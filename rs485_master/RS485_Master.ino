...
#if defined(ISDEBUG)
                Serial.println("Message is not a confirmation of our last command: SENT: "
...
#if defined(ISDEBUG)
                        Serial.println("Message does not contain expected value of sent command value at data index "
